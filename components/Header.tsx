...
export default function Header() {
	...
	return (
		<>
			...
			<header
				ref={headerRef}
				className={`fixed top-0 inset-x-0 z-50 ${bgCls} text-porcelain transition-transform duration-500 ${
				...
				<div className='container mx-auto grid grid-cols-3 items-center pt-2 pb-2 px-4 md:px-0'>
					...
					<div className='flex items-center gap-4 text-porcelain/90 justify-self-start'>
						<Link
							...
							href='https://www.instagram.com/made_in_sicily_taormina/'
						...
						>
							<svg
								...
								aria-hidden='true'
							>
								<path d='M7 2h10a5 5 0 0 1 5 5v10a5 5 0 0 1-5 5H7a5 5 0 0 1-5-5V7a5 5 0 0 1 5-5zm0 2a3 3 0 0 0-3 3v10a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V7a3 3 0 0 0-3-3H7zm5 3a5 5 0 1 1 0 10 5 5 0 0 1 0-10zm5.5-.75a1.25 1.25 0 1 1 0 2.5 1.25 1.25 0 0 1 0-2.5z' />
							</svg>
						</Link>
						<Link
							aria-label='Facebook'
							href='https://www.facebook.com/madeinsicilytaormina'
							className='hover:text-sunshine transition-colors'
						>
							<svg
								width='18'
					...
					<div className='flex items-center justify-center'>
						<Link
							...
							aria-label='Taormina – Lava Stone & Ceramics home'
						>
							<Image
							...
							{langOpen && (
								...
								>
									<button
										...
										className={`block w-full text-left px-3 py-2 text-sm hover:bg-porcelain/80 ${
											lang === 'it' ? 'font-medium' : ''
										}`}
									>
										Italiano
						...
						{[
							...
							return (
								<li key={item.href}>
									<Link
										href={item.href}
										className={`uppercase tracking-wider link-underline transition-colors ${
											active
												? 'text-sunshine'
												: 'hover:text-sunshine/90'
										}`}
										aria-current={
			...
			{mobileOpen && (
				<div
					className='fixed inset-0 z-[80] bg-[var(--color-text)] text-porcelain flex flex-col'
					role='dialog'
					aria-modal='true'
					...
					<nav className='flex-1 flex flex-col items-center justify-center gap-6 px-6'>
						...
						<ul className='w-full max-w-md'>
							{[
								...
								<li
									key={item.href}
									className='border-t border-porcelain/15 first:border-t-0'
								>
									<Link
										href={item.href}
										onClick={() => setMobileOpen(false)}
