...
export default function Footer() {
	...
	// Contact details
	const displayPhone = '+39 347 609 7090';
	const telHref = 'tel:+393476097090';
	const email = 'madeinsicilyinfo@gmail.com';
	const address = 'Via Calapitrulli, 5';
	const mapsHref = 'https://maps.app.goo.gl/hJFzveab5hY5PzyE7';

	// WhatsApp preset message per locale
	const waNumber = '393476097090'; // E.164 without +
